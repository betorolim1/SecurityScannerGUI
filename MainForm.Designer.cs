namespace SecurityHeaderScannerGUI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            var bgCard =
                System.Drawing.Color.FromArgb(32, 34, 44);

            var bgHeader =
                System.Drawing.Color.FromArgb(18, 18, 26);

            var bgStatus =
                System.Drawing.Color.FromArgb(18, 18, 26);

            var textPrimary =
                System.Drawing.Color.FromArgb(230, 232, 240);

            var textSecondary =
                System.Drawing.Color.FromArgb(140, 145, 165);

            var accentGreen =
                System.Drawing.Color.FromArgb(46, 204, 113);

            var borderColor =
                System.Drawing.Color.FromArgb(50, 54, 68);

            var btnSecondaryBg =
                System.Drawing.Color.FromArgb(44, 47, 60);

            var btnSecondaryHover =
                System.Drawing.Color.FromArgb(55, 58, 72);
            ...
            this.lblIcon.Font =
                new System.Drawing.Font("Segoe UI Emoji", 22F);
            ...
            this.lblTitle.Location =
                new System.Drawing.Point(72, 14);
            ...
            // ═══════════════════════════════════════════
            // panelUrlContainer — card com lista de URLs
            // ═══════════════════════════════════════════

            this.panelUrlContainer.BackColor = bgCard;

            this.panelUrlContainer.Location =
                new System.Drawing.Point(20, 84);

            this.panelUrlContainer.Size =
                new System.Drawing.Size(710, 380);

            this.panelUrlContainer.Anchor =
            ...
            this.lblUrlsHeader.Text =
                "  URLs para análise";

            this.lblUrlsHeader.Font =
                new System.Drawing.Font(
                    "Segoe UI Semibold",
                    10F);

            this.lblUrlsHeader.ForeColor =
                textSecondary;

            this.lblUrlsHeader.BackColor =
                System.Drawing.Color.FromArgb(28, 30, 40);

            this.lblUrlsHeader.Location =
                new System.Drawing.Point(0, 0);

            this.lblUrlsHeader.Size =
                new System.Drawing.Size(710, 34);

            this.lblUrlsHeader.TextAlign =
                System.Drawing.ContentAlignment.MiddleLeft;

            this.lblUrlsHeader.Padding =
                new System.Windows.Forms.Padding(8, 0, 0, 0);

            this.lblUrlsHeader.Anchor =
                System.Windows.Forms.AnchorStyles.Top
                | System.Windows.Forms.AnchorStyles.Left
                | System.Windows.Forms.AnchorStyles.Right;
            ...
            this.flowUrls.Location =
                new System.Drawing.Point(0, 34);

            this.flowUrls.Size =
                new System.Drawing.Size(710, 346);

            this.flowUrls.Padding =
                new System.Windows.Forms.Padding(8, 6, 8, 6);

            this.flowUrls.Anchor =
                System.Windows.Forms.AnchorStyles.Top
                | System.Windows.Forms.AnchorStyles.Bottom
                | System.Windows.Forms.AnchorStyles.Left
                | System.Windows.Forms.AnchorStyles.Right;
            ...
            this.panelUrlContainer.Controls.Add(
                this.lblUrlsHeader);
            ...
            this.progressBar.Location =
                new System.Drawing.Point(20, 468);

            this.progressBar.Size =
                new System.Drawing.Size(710, 4);
            ...
            this.panelActions.Location =
                new System.Drawing.Point(20, 476);

            this.panelActions.Size =
                new System.Drawing.Size(710, 52);

            this.panelActions.Anchor =
                System.Windows.Forms.AnchorStyles.Bottom
                | System.Windows.Forms.AnchorStyles.Left
                | System.Windows.Forms.AnchorStyles.Right;
            ...
            this.btnAdd.FlatAppearance.BorderColor =
                borderColor;

            this.btnAdd.FlatAppearance.BorderSize = 1;

            this.btnAdd.FlatAppearance.MouseOverBackColor =
                btnSecondaryHover;
            ...
            this.btnAddList.FlatStyle =
                System.Windows.Forms.FlatStyle.Flat;

            this.btnAddList.FlatAppearance.BorderColor =
                borderColor;

            this.btnAddList.FlatAppearance.BorderSize = 1;

            this.btnAddList.FlatAppearance.MouseOverBackColor =
                btnSecondaryHover;

            this.btnAddList.BackColor =
                btnSecondaryBg;

            this.btnAddList.ForeColor =
                textPrimary;

            this.btnAddList.Font =
                new System.Drawing.Font(
                    "Segoe UI",
                    9.5F);

            this.btnAddList.Size =
                new System.Drawing.Size(165, 38);

            this.btnAddList.Location =
                new System.Drawing.Point(153, 7);

            this.btnAddList.Text =
                "\u2630  Adicionar por lista";

            this.btnAddList.Cursor =
                System.Windows.Forms.Cursors.Hand;

            this.btnAddList.TabIndex = 2;

            this.btnAddList.Anchor =
                System.Windows.Forms.AnchorStyles.Bottom
                | System.Windows.Forms.AnchorStyles.Left;

            this.btnAddList.Click +=
                new System.EventHandler(
                    this.btnAddList_Click);
            ...
            this.btnScan.FlatStyle =
                System.Windows.Forms.FlatStyle.Flat;

            this.btnScan.FlatAppearance.BorderSize = 0;

            this.btnScan.FlatAppearance.MouseOverBackColor =
                System.Drawing.Color.FromArgb(36, 180, 96);

            this.btnScan.BackColor =
                accentGreen;

            this.btnScan.ForeColor =
            ...
            this.btnScan.Size =
                new System.Drawing.Size(148, 38);

            this.btnScan.Location =
                new System.Drawing.Point(562, 7);
            ...
            this.lblUrlCount.Font =
                new System.Drawing.Font(
                    "Segoe UI",
                    8.5F);

            this.lblUrlCount.ForeColor =
                textSecondary;

            this.lblUrlCount.BackColor =
                bgStatus;

            this.lblUrlCount.Dock =
                System.Windows.Forms.DockStyle.Right;

            this.lblUrlCount.Width = 120;

            this.lblUrlCount.TextAlign =
                System.Drawing.ContentAlignment.MiddleRight;

            this.lblUrlCount.Padding =
                new System.Windows.Forms.Padding(
                    0, 0, 12, 0);


            this.panelStatus.Controls.Add(
                this.lblStatus);
            ...
            this.toolTip.BackColor =
                System.Drawing.Color.FromArgb(50, 54, 68);

            this.toolTip.ForeColor =
                textPrimary;

            this.toolTip.SetToolTip(
                this.btnAdd,
                "Adicionar um novo campo de URL");

            this.toolTip.SetToolTip(
                this.btnAddList,
                "Colar uma lista de URLs de uma só vez");

            this.toolTip.SetToolTip(
                this.btnScan,
                "Executar análise de cabeçalhos HTTP em todas as URLs");
            ...
            this.ClientSize =
                new System.Drawing.Size(750, 550);
